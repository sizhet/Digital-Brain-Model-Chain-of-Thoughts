...
1. Retrieving all Euclidean components (for Phase-1 search);

2. Computing metric distance between IStarmap pairs (for Phase-2 ranking);

3. Extracting subset matches between IStarmap pairs (for CCC discovery).
